...
complete --command bitcoinIII-qt --no-files

# Extract options
function __fish_bitcoinIIIqt_get_options
...
complete \
    --command bitcoinIII-qt \
    --arguments "(__fish_bitcoinIIIqt_get_options)"
# Enable file completions only if the commandline now contains a `*.=` style option
complete -c bitcoinIII-qt \
...
complete \
    --command bitcoinIII-qt \
    --arguments "(__fish_bitcoinIIIqt_get_options --nofiles)"
