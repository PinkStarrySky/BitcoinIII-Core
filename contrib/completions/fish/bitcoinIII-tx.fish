...
# Extract options
function __fish_bitcoinIII_tx_get_options
...
# Extract commands
function __fish_bitcoinIII_tx_get_commands
...
# Add options
complete \
    --command bitcoinIII-tx \
    --condition "not __fish_bitcoinIII_seen_cmd (__fish_bitcoinIII_tx_get_commands --commandsonly)" \
    --arguments "(__fish_bitcoinIII_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command bitcoinIII-tx \
    --arguments "(__fish_bitcoinIII_tx_get_commands)" \
    --no-files
