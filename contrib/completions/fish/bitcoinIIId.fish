...
complete --command bitcoinIIId --no-files

# Extract options
function __fish_bitcoinIIId_get_options
...
complete \
    --command bitcoinIIId \
    --arguments "(__fish_bitcoinIIId_get_options --nofiles)"
