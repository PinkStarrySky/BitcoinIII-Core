...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef BITCOINIII_CHAINPARAMSSEEDS_H\n')
    g.write('#define BITCOINIII_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the bitcoinIII network\n')
    ...
    g.write('#endif // BITCOINIII_CHAINPARAMSSEEDS_H\n')
