...
Assumeutxo is a feature that allows fast bootstrapping of a validating bitcoinIIId
instance.
...
```
$ bitcoinIII-cli -rpcclienttimeout=0 loadtxoutset /path/to/input
```
...
```
$ bitcoinIII-cli -rpcclienttimeout=0 dumptxoutset /path/to/output rollback
```
