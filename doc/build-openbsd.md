...
This guide describes how to build bitcoinIIId, command-line utilities, and GUI on OpenBSD.
...
...
to: /path/to/bitcoinIII/depends/*-unknown-openbsd*
```
...
(see issue [#6658](https://github.com/bitcoinIII/bitcoinIII/issues/6658)).
