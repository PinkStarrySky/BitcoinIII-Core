...
```sh
cmake --build build --target bitcoinIIId bitcoinIII-cli
cmake --build build --target bitcoinIII-qt
cmake --build build --target bench_bitcoinIII
```
...
[remote "upstream-pull"]
        ...
        url = git@github.com:bitcoinIII/bitcoinIII.git
```
