BitcoinIII Core version 0.10.4 is now available from:

  <https://bitcoin.org/bin/bitcoinIII-core-0.10.4/>
...
- #6953 `43c2789` Split bitcoinIII-tx into its own package
- #6953 `dfe0d4d` Include bitcoinIII-tx binary on Debian/Ubuntu
