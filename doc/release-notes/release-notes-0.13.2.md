BitcoinIII Core version 0.13.2 is now available from:

  <https://bitcoin.org/bin/bitcoinIII-core-0.13.2/>
...
- #8908 `4a974b2` Update bitcoinIII-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow bitcoinIII-tx to create v2 transactions (btcdrak)
