BitcoinIII Core version *0.15.0.1* is now available from:

  <https://bitcoin.org/bin/bitcoinIII-core-0.15.0.1/>

and

  <https://bitcoincore.org/bin/bitcoinIII-core-0.15.0.1/>
