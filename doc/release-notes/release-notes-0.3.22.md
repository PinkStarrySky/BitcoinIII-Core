Download URL: https://sourceforge.net/projects/bitcoinIII/files/BitcoinIII/bitcoinIII-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 BC3 fee schedule (users still pay 0.01 BC3 per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #bitcoinIII00 - #bitcoinIII99
