BitcoinIII version 0.5.4 is now available for download at:
http://sourceforge.net/projects/bitcoinIII/files/BitcoinIII/bitcoinIII-0.5.4/
...
http://gitorious.org/bitcoinIII/bitcoinIIId-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix BitcoinIII-Qt notifications under Growl 1.3.
Increase required age of BitcoinIII-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBitcoinIII properly when installing BitcoinIII-Qt over it. (Windows)
