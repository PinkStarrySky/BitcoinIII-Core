BitcoinIII-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/bitcoinIII/files/BitcoinIII/bitcoinIII-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the BitcoinIII
...
New/changed settings (command-line or bitcoinIII.conf file)
--------------------------------------------------------
