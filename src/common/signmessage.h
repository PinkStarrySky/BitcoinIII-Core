...
#ifndef BITCOINIII_COMMON_SIGNMESSAGE_H
#define BITCOINIII_COMMON_SIGNMESSAGE_H
 ...
 * @param[in] address Signer's bitcoinIII address, it must refer to a public key.
...
#endif // BITCOINIII_COMMON_SIGNMESSAGE_H
