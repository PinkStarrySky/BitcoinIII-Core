...
//! that can be used internally by functions in the libbitcoinIII_common library,
...
#ifndef BITCOINIII_COMMON_TYPES_H
#define BITCOINIII_COMMON_TYPES_H
...
#endif // BITCOINIII_COMMON_TYPES_H
