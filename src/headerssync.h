...
#ifndef BITCOINIII_HEADERSSYNC_H
#define BITCOINIII_HEADERSSYNC_H
 ...
 *
 * The BitcoinIII protocol does not offer an easy way to determine the work on a
...
#endif // BITCOINIII_HEADERSSYNC_H
