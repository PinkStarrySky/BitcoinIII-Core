...
node::RejectedTxTodo TxDownloadManagerImpl::MempoolRejectedTx(const CTransactionRef& ptx, const TxValidationState& state, NodeId nodeid, bool first_time_failure)
{
    ...
    if (state.GetResult() == TxValidationResult::TX_MISSING_INPUTS) {
        ...
        // https://github.com/bitcoinIII/bitcoinIII/issues/8279 for details.
        // We can remove this restriction (and always add wtxids to
        // the filter even for witness stripped transactions) once
        // wtxid-based relay is broadly deployed.
        // See also comments in https://github.com/bitcoinIII/bitcoinIII/pull/18044#discussion_r443419034
