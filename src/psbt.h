...
#ifndef BITCOINIII_PSBT_H
#define BITCOINIII_PSBT_H
...
struct PartiallySignedTransaction
{
    ...
    /** Merge psbt into this. The two psbts must have the same underlying CTransaction (i.e. the
      * same actual BitcoinIII transaction.) Returns true if the merge succeeded, false otherwise. */
