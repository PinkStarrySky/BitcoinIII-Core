...
const std::string BitcoinIIIGUI::DEFAULT_UIPLATFORM =
...
BitcoinIIIGUI::BitcoinIIIGUI(interfaces::Node& node, const PlatformStyle *_platformStyle, const NetworkStyle *networkStyle, QWidget *parent) :
    QMainWindow(parent),
    m_node(node),
    ...
    m_network_style(networkStyle)
{
    ...
    if(enableWallet)
    {
        ...
        connect(walletFrame, &WalletFrame::createWalletButtonClicked, this, &BitcoinIIIGUI::createWallet);
    ...
    connect(labelBlocksIcon, &GUIUtil::ClickableLabel::clicked, this, &BitcoinIIIGUI::showModalOverlay);
    connect(progressBar, &GUIUtil::ClickableProgressBar::clicked, this, &BitcoinIIIGUI::showModalOverlay);
...
void BitcoinIIIGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a BitcoinIII address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and bitcoinIII: URIs)"));
    ...
    connect(overviewAction, &QAction::triggered, this, &BitcoinIIIGUI::gotoOverviewPage);
    connect(sendCoinsAction, &QAction::triggered, [this]{ showNormalIfMinimized(); });
    connect(sendCoinsAction, &QAction::triggered, [this]{ gotoSendCoinsPage(); });
    connect(receiveCoinsAction, &QAction::triggered, [this]{ showNormalIfMinimized(); });
    connect(receiveCoinsAction, &QAction::triggered, this, &BitcoinIIIGUI::gotoReceiveCoinsPage);
    connect(historyAction, &QAction::triggered, [this]{ showNormalIfMinimized(); });
    connect(historyAction, &QAction::triggered, this, &BitcoinIIIGUI::gotoHistoryPage);
#endif // ENABLE_WALLET
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your BitcoinIII addresses to prove you own them"));
    verifyMessageAction = new QAction(tr("&Verify message…"), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified BitcoinIII addresses"));
    m_load_psbt_action = new QAction(tr("&Load PSBT from file…"), this);
    m_load_psbt_action->setStatusTip(tr("Load Partially Signed BitcoinIII Transaction"));
    m_load_psbt_clipboard_action = new QAction(tr("Load PSBT from &clipboard…"), this);
    m_load_psbt_clipboard_action->setStatusTip(tr("Load Partially Signed BitcoinIII Transaction from clipboard"));
    ...
    openAction->setStatusTip(tr("Open a bitcoinIII: URI"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible BitcoinIII command-line options").arg(CLIENT_NAME));
    ...
    connect(quitAction, &QAction::triggered, this, &BitcoinIIIGUI::quitRequested);
    connect(aboutAction, &QAction::triggered, this, &BitcoinIIIGUI::aboutClicked);
    connect(aboutQtAction, &QAction::triggered, qApp, QApplication::aboutQt);
    connect(optionsAction, &QAction::triggered, this, &BitcoinIIIGUI::optionsClicked);
    connect(showHelpMessageAction, &QAction::triggered, this, &BitcoinIIIGUI::showHelpMessageClicked);
    connect(openRPCConsoleAction, &QAction::triggered, this, &BitcoinIIIGUI::showDebugWindow);
    ...
    if(walletFrame)
    {
        ...
        connect(openAction, &QAction::triggered, this, &BitcoinIIIGUI::openClicked);
        connect(m_open_wallet_menu, &QMenu::aboutToShow, [this] {
            ...
            for (const auto& [path, info] : m_wallet_controller->listWalletDir()) {
                ...
                connect(action, &QAction::triggered, [this, path] {
                    ...
                    connect(activity, &OpenWalletActivity::opened, this, &BitcoinIIIGUI::setCurrentWallet, Qt::QueuedConnection);
        ...
        connect(m_restore_wallet_action, &QAction::triggered, [this] {
            ...
            connect(activity, &RestoreWalletActivity::restored, this, &BitcoinIIIGUI::setCurrentWallet, Qt::QueuedConnection);
        ...
        connect(m_create_wallet_action, &QAction::triggered, this, &BitcoinIIIGUI::createWallet);
        ...
        connect(m_migrate_wallet_menu, &QMenu::aboutToShow, [this] {
            ...
            for (const auto& [wallet_name, info] : m_wallet_controller->listWalletDir()) {
                ...
                connect(action, &QAction::triggered, [this, wallet_name] {
                    ...
                    connect(activity, &MigrateWalletActivity::migrated, this, &BitcoinIIIGUI::setCurrentWallet);
        ...
        connect(m_mask_values_action, &QAction::toggled, this, &BitcoinIIIGUI::setPrivacy);
        connect(m_mask_values_action, &QAction::toggled, this, &BitcoinIIIGUI::enableHistoryAction);
    }
#endif // ENABLE_WALLET

    connect(new QShortcut(QKeySequence(Qt::CTRL | Qt::SHIFT | Qt::Key_C), this), &QShortcut::activated, this, &BitcoinIIIGUI::showDebugWindowActivateConsole);
    connect(new QShortcut(QKeySequence(Qt::CTRL | Qt::SHIFT | Qt::Key_D), this), &QShortcut::activated, this, &BitcoinIIIGUI::showDebugWindow);
}

void BitcoinIIIGUI::createMenuBar()
{
    appMenuBar = menuBar();
...
void BitcoinIIIGUI::createToolBars()
{
    if(walletFrame)
    {
        ...
        connect(m_wallet_selector, qOverload<int>(&QComboBox::currentIndexChanged), this, &BitcoinIIIGUI::setCurrentWalletBySelectorIndex);
...
void BitcoinIIIGUI::setClientModel(ClientModel *_clientModel, interfaces::BlockAndHeaderTipInfo* tip_info)
{
    ...
    if(_clientModel)
    {
        ...
        connect(_clientModel, &ClientModel::numConnectionsChanged, this, &BitcoinIIIGUI::setNumConnections);
        connect(_clientModel, &ClientModel::networkActiveChanged, this, &BitcoinIIIGUI::setNetworkActive);
        ...
        connect(_clientModel, &ClientModel::numBlocksChanged, this, &BitcoinIIIGUI::setNumBlocks);
        ...
        connect(_clientModel, &ClientModel::showProgress, this, &BitcoinIIIGUI::showProgress);
...
#ifdef ENABLE_WALLET
void BitcoinIIIGUI::enableHistoryAction(bool privacy)
{
...
void BitcoinIIIGUI::setWalletController(WalletController* wallet_controller, bool show_loading_minimized)
{
    ...
    GUIUtil::ExceptionSafeConnect(wallet_controller, &WalletController::walletAdded, this, &BitcoinIIIGUI::addWallet);
    connect(wallet_controller, &WalletController::walletRemoved, this, &BitcoinIIIGUI::removeWallet);
...
WalletController* BitcoinIIIGUI::getWalletController()
{
    return m_wallet_controller;
}

void BitcoinIIIGUI::addWallet(WalletModel* walletModel)
{
    ...
    connect(wallet_view, &WalletView::outOfSyncWarningClicked, this, &BitcoinIIIGUI::showModalOverlay);
    connect(wallet_view, &WalletView::transactionClicked, this, &BitcoinIIIGUI::gotoHistoryPage);
    connect(wallet_view, &WalletView::coinsSent, this, &BitcoinIIIGUI::gotoHistoryPage);
    connect(wallet_view, &WalletView::message, [this](const QString& title, const QString& message, unsigned int style) {
        this->message(title, message, style);
    });
    connect(wallet_view, &WalletView::encryptionStatusChanged, this, &BitcoinIIIGUI::updateWalletStatus);
    connect(wallet_view, &WalletView::incomingTransaction, this, &BitcoinIIIGUI::incomingTransaction);
    connect(this, &BitcoinIIIGUI::setPrivacy, wallet_view, &WalletView::setPrivacy);
...
void BitcoinIIIGUI::removeWallet(WalletModel* walletModel)
{
...
void BitcoinIIIGUI::setCurrentWallet(WalletModel* wallet_model)
{
    if (!walletFrame || !m_wallet_controller) return;
...
void BitcoinIIIGUI::setCurrentWalletBySelectorIndex(int index)
{
    WalletModel* wallet_model = m_wallet_selector->itemData(index).value<WalletModel*>();
    if (wallet_model) setCurrentWallet(wallet_model);
}

void BitcoinIIIGUI::removeAllWallets()
{
    if(!walletFrame)
        return;
    setWalletActionsEnabled(false);
...
void BitcoinIIIGUI::setWalletActionsEnabled(bool enabled)
{
...
void BitcoinIIIGUI::createTrayIcon()
{
...
void BitcoinIIIGUI::createTrayIconMenu()
{
#ifndef Q_OS_MACOS
    if (!trayIcon) return;
#endif // Q_OS_MACOS
    ...
    show_hide_action = trayIconMenu->addAction(QString(), this, &BitcoinIIIGUI::toggleHidden);
...
void BitcoinIIIGUI::optionsClicked()
{
    openOptionsDialogWithTab(OptionsDialog::TAB_MAIN);
}

void BitcoinIIIGUI::aboutClicked()
{
    if(!clientModel)
        return;
...
void BitcoinIIIGUI::showDebugWindow()
{
    GUIUtil::bringToFront(rpcConsole);
    Q_EMIT consoleShown(rpcConsole);
}

void BitcoinIIIGUI::showDebugWindowActivateConsole()
{
    rpcConsole->setTabFocus(RPCConsole::TabTypes::CONSOLE);
    showDebugWindow();
}

void BitcoinIIIGUI::showHelpMessageClicked()
{
    GUIUtil::bringToFront(helpMessageDialog);
}

#ifdef ENABLE_WALLET
void BitcoinIIIGUI::openClicked()
{
...
void BitcoinIIIGUI::gotoOverviewPage()
{
    overviewAction->setChecked(true);
    if (walletFrame) walletFrame->gotoOverviewPage();
}

void BitcoinIIIGUI::gotoHistoryPage()
{
    historyAction->setChecked(true);
    if (walletFrame) walletFrame->gotoHistoryPage();
}

void BitcoinIIIGUI::gotoReceiveCoinsPage()
{
    receiveCoinsAction->setChecked(true);
    if (walletFrame) walletFrame->gotoReceiveCoinsPage();
}

void BitcoinIIIGUI::gotoSendCoinsPage(QString addr)
{
    sendCoinsAction->setChecked(true);
    if (walletFrame) walletFrame->gotoSendCoinsPage(addr);
}

void BitcoinIIIGUI::gotoSignMessageTab(QString addr)
{
    if (walletFrame) walletFrame->gotoSignMessageTab(addr);
}

void BitcoinIIIGUI::gotoVerifyMessageTab(QString addr)
{
    if (walletFrame) walletFrame->gotoVerifyMessageTab(addr);
}
void BitcoinIIIGUI::gotoLoadPSBT(bool from_clipboard)
{
    if (walletFrame) walletFrame->gotoLoadPSBT(from_clipboard);
}
#endif // ENABLE_WALLET

void BitcoinIIIGUI::updateNetworkState()
{
    ...
    if (m_node.getNetworkActive()) {
        ...
        tooltip = tr("%n active connection(s) to BitcoinIII network.", "", count);
    } else {
        //: A substring of the tooltip.
...
void BitcoinIIIGUI::setNumConnections(int count)
{
    updateNetworkState();
}

void BitcoinIIIGUI::setNetworkActive(bool network_active)
{
    updateNetworkState();
...
void BitcoinIIIGUI::updateHeadersSyncProgressLabel()
{
...
void BitcoinIIIGUI::updateHeadersPresyncProgressLabel(int64_t height, const QDateTime& blockDate)
{
...
void BitcoinIIIGUI::openOptionsDialogWithTab(OptionsDialog::Tab tab)
{
    if (!clientModel || !clientModel->getOptionsModel())
        return;

    auto dlg = new OptionsDialog(this, enableWallet);
    connect(dlg, &OptionsDialog::quitOnReset, this, &BitcoinIIIGUI::quitRequested);
...
void BitcoinIIIGUI::setNumBlocks(int count, const QDateTime& blockDate, double nVerificationProgress, SyncType synctype, SynchronizationState sync_state)
{
...
void BitcoinIIIGUI::createWallet()
{
#ifdef ENABLE_WALLET
#ifndef USE_SQLITE
    ...
    connect(activity, &CreateWalletActivity::created, this, &BitcoinIIIGUI::setCurrentWallet);
    connect(activity, &CreateWalletActivity::created, rpcConsole, &RPCConsole::setCurrentWallet);
    activity->create();
#endif // ENABLE_WALLET
}

void BitcoinIIIGUI::message(const QString& title, QString message, unsigned int style, bool* ret, const QString& detailed_message)
{
...
void BitcoinIIIGUI::changeEvent(QEvent *e)
{
    ...
    if(e->type() == QEvent::WindowStateChange)
    {
        if(clientModel && clientModel->getOptionsModel() && clientModel->getOptionsModel()->getMinimizeToTray())
        {
            ...
            {
                QTimer::singleShot(0, this, &BitcoinIIIGUI::hide);
                e->ignore();
            }
            else if((wsevt->oldState() & Qt::WindowMinimized) && !isMinimized())
            {
                QTimer::singleShot(0, this, &BitcoinIIIGUI::show);
                e->ignore();
            }
        }
    }
...
void BitcoinIIIGUI::closeEvent(QCloseEvent *event)
{
#ifndef Q_OS_MACOS // Ignored on Mac
    if(clientModel && clientModel->getOptionsModel())
    {
...
void BitcoinIIIGUI::showEvent(QShowEvent *event)
{
...
#ifdef ENABLE_WALLET
void BitcoinIIIGUI::incomingTransaction(const QString& date, BitcoinIIIUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName)
{
    // On new transaction, make an info balloon
    QString msg = tr("Date: %1\n").arg(date) +
                  tr("Amount: %1\n").arg(BitcoinIIIUnits::formatWithUnit(unit, amount, true));
...
void BitcoinIIIGUI::dragEnterEvent(QDragEnterEvent *event)
{
    // Accept only URIs
...
void BitcoinIIIGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
...
bool BitcoinIIIGUI::eventFilter(QObject *object, QEvent *event)
{
...
#ifdef ENABLE_WALLET
bool BitcoinIIIGUI::handlePaymentRequest(const SendCoinsRecipient& recipient)
{
    // URI has to be valid
...
void BitcoinIIIGUI::setHDStatus(bool privkeyDisabled, int hdEnabled)
{
...
void BitcoinIIIGUI::setEncryptionStatus(int status)
{
    switch(status)
    {
...
void BitcoinIIIGUI::updateWalletStatus()
{
    assert(walletFrame);
...
void BitcoinIIIGUI::updateProxyIcon()
{
    std::string ip_port;
...
void BitcoinIIIGUI::updateWindowTitle()
{
...
void BitcoinIIIGUI::showNormalIfMinimized(bool fToggleHidden)
{
    if(!clientModel)
        return;
...
void BitcoinIIIGUI::toggleHidden()
{
    showNormalIfMinimized(true);
}

void BitcoinIIIGUI::detectShutdown()
{
...
void BitcoinIIIGUI::showProgress(const QString &title, int nProgress)
{
    if (nProgress == 0) {
...
void BitcoinIIIGUI::showModalOverlay()
{
    if (modalOverlay && (progressBar->isVisible() || modalOverlay->isLayerVisible()))
        modalOverlay->toggleVisibility();
}

static bool ThreadSafeMessageBox(BitcoinIIIGUI* gui, const bilingual_str& message, const std::string& caption, unsigned int style)
{
    ...
    if (message.original != message.translated) {
        detailed_message = BitcoinIIIGUI::tr("Original message:") + "\n" + QString::fromStdString(message.original);
    }
...
void BitcoinIIIGUI::subscribeToCoreSignals()
{
...
void BitcoinIIIGUI::unsubscribeFromCoreSignals()
{
...
bool BitcoinIIIGUI::isPrivacyModeActivated() const
{
    ...
    : m_platform_style{platformStyle}
{
    ...
    QList<BitcoinIIIUnit> units = BitcoinIIIUnits::availableUnits();
    int max_width = 0;
    const QFontMetrics fm(font());
    for (const BitcoinIIIUnit unit : units) {
        max_width = qMax(max_width, GUIUtil::TextWidth(fm, BitcoinIIIUnits::longName(unit)));
    }
...
{
    menu = new QMenu(this);
    for (const BitcoinIIIUnit u : BitcoinIIIUnits::availableUnits()) {
        menu->addAction(BitcoinIIIUnits::longName(u))->setData(QVariant::fromValue(u));
    }
...
void UnitDisplayStatusBarControl::updateDisplayUnit(BitcoinIIIUnit newUnits)
{
    setText(BitcoinIIIUnits::longName(newUnits));
}
