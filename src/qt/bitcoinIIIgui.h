...
#ifndef BITCOINIII_QT_BITCOINGUI_H
#define BITCOINIII_QT_BITCOINGUI_H
...
/**
  BitcoinIII GUI main class. This class represents the main window of the BitcoinIII UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class BitcoinIIIGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit BitcoinIIIGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~BitcoinIIIGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a bitcoinIII wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
public Q_SLOTS:
    ...
    void incomingTransaction(const QString& date, BitcoinIIIUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName);
#endif // ENABLE_WALLET
...
public Q_SLOTS:
    ...
    /** Load Partially Signed BitcoinIII Transaction from file or clipboard */
...
private Q_SLOTS:
    ...
    void updateDisplayUnit(BitcoinIIIUnit newUnits);
    /** Tells underlying optionsModel to update its current display unit. */
    void onMenuSelection(QAction* action);
};

#endif // BITCOINIII_QT_BITCOINGUI_H
