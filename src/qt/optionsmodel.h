...
#ifndef BITCOINIII_QT_OPTIONSMODEL_H
#define BITCOINIII_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for BitcoinIII client.
...
public:
    ...
    BitcoinIIIUnit getDisplayUnit() const { return m_display_bitcoinIII_unit; }
    QString getThirdPartyTxUrls() const { return strThirdPartyTxUrls; }
    QFont getFontForMoney() const;
    bool getCoinControlFeatures() const { return fCoinControlFeatures; }
    bool getSubFeeFromAmount() const { return m_sub_fee_from_amount; }
    bool getEnablePSBC3ontrols() const { return m_enable_psbt_controls; }
...
private:
    ...
    QString language;
    BitcoinIIIUnit m_display_bitcoinIII_unit;
...
Q_SIGNALS:
    void displayUnitChanged(BitcoinIIIUnit unit);
...
#endif // BITCOINIII_QT_OPTIONSMODEL_H
