...
//! Entry point for BitcoinIIIApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &BitcoinIIIApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for BitcoinIIIGUI tests.
void AppTests::guiTests(BitcoinIIIGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &BitcoinIIIGUI::consoleShown, this, &AppTests::consoleTests);
