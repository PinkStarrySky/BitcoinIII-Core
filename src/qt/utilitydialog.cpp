    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (about)
    {
        ...
        QString header = "The bitcoinIII-qt application provides a graphical interface for interacting with " CLIENT_NAME ".\n\n"
                         "It combines the core functionalities of bitcoinIIId with a user-friendly interface for wallet management, transaction history, and network statistics.\n\n"
                         ...
                         "Usage: bitcoinIII-qt [options] [URI]\n\n";
