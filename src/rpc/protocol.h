...
#ifndef BITCOINIII_RPC_PROTOCOL_H
#define BITCOINIII_RPC_PROTOCOL_H
...
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in bitcoinIIId
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< BitcoinIII is not connected
...
#endif // BITCOINIII_RPC_PROTOCOL_H
