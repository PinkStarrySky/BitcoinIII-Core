...
#ifndef BITCOINIII_SCRIPT_SCRIPT_H
#define BITCOINIII_SCRIPT_SCRIPT_H
...
public:
    ...
    /**
     * Pre-version-0.6, BitcoinIII always counted CHECKMULTISIGs
...
#endif // BITCOINIII_SCRIPT_SCRIPT_H
