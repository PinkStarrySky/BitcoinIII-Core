...
#ifndef BITCOINIII_TEST_SCRIPTNUM10_H
#define BITCOINIII_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from BitcoinIII Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // BITCOINIII_TEST_SCRIPTNUM10_H
