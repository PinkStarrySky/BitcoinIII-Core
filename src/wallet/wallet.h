...
#ifndef BITCOINIII_WALLET_WALLET_H
#define BITCOINIII_WALLET_WALLET_H
...
public:
     ...
     * bitcoinIII-wallet tool code or by wallet migration code. If this is called
...
#endif // BITCOINIII_WALLET_WALLET_H
