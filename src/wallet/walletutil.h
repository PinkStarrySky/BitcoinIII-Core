...
#ifndef BITCOINIII_WALLET_WALLETUTIL_H
#define BITCOINIII_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! bitcoinIII from opening the wallet, thinking it was newly created, and
...
#endif // BITCOINIII_WALLET_WALLETUTIL_H
