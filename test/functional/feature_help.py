...
"""Verify that starting bitcoinIII with -h works as expected."""

from test_framework.test_framework import BitcoinIIITestFramework
from test_framework.util import assert_equal

class HelpTest(BitcoinIIITestFramework):
    ...
    def run_test(self):
        self.log.info("Start bitcoinIII with -h for help text")
        ...
        self.log.info("Start bitcoinIII with -version for version information")
        ...
        self.log.info("Start bitcoinIIId with -fakearg to make sure it does not start")
