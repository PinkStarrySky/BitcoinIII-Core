...
class ReplaceByFeeTest(BitcoinIIITestFramework):
    ...
    def test_simple_doublespend(self):
        ...
        reject_details = f"{reject_reason}, rejecting replacement {tx.hash}; new feerate 0.00300000 BC3/kvB <= old feerate 0.00300000 BC3/kvB"
    ...
    def test_doublespend_chain(self):
        ...
        # child fees - 4 BC3 - so this attempt is rejected.
