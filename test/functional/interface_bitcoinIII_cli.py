...
# The block reward of coinbaseoutput.nValue (50) BC3/block matures after
# COINBASE_MATURITY (100) blocks. Therefore, after mining 101 blocks we expect
# node 0 to have a balance of (BLOCKS - COINBASE_MATURITY) * 50 BC3/block.
...
WALLET_NOT_SPECIFIED = (
    ...
    "option before the command (run \"bitcoinIII-cli -h\" for help or \"bitcoinIII-cli listwallets\" to see "
...
class TestBitcoinIIICli(BitcoinIIITestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `bitcoinIII-cli getblockchaininfo`")
        ...
        # Prevent bitcoinIII-cli from using existing rpcport in conf
        ...
        self.log.info("Test -getinfo and bitcoinIII-cli return all proxies")
        ...
        if self.is_specified_wallet_compiled():
            self.log.info("Test -getinfo and bitcoinIII-cli getwalletinfo return expected wallet info")
            ...
            assert_equal(Decimal(cli_get_info['Transaction fee rate (-paytxfee) (BC3/kvB)']), wallet_info['paytxfee'])
            assert_equal(Decimal(cli_get_info['Min tx relay fee rate (BC3/kvB)']), network_info['relayfee'])
            ...
            # Mine a block to confirm; adds a block reward (50 BC3) to the default wallet.
            ...
            # Test bitcoinIII-cli -generate with -rpcwallet in multiwallet mode.
...
if __name__ == '__main__':
    TestBitcoinIIICli(__file__).main()
