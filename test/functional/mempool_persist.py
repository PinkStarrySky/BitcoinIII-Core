...
By default, bitcoinIIId will dump mempool on shutdown and
...
class MempoolPersistTest(BitcoinIIITestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent bitcoinIIId from writing mempool.dat to disk. Verify that `savemempool` fails")
