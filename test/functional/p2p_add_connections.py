...
class P2PFeelerReceiver(P2PInterface):
    def on_version(self, message):
        # The bitcoinIIId node closes feeler connections as soon as a version
...
class P2PAddConnections(BitcoinIIITestFramework):
    ...
    def run_test(self):
        ...
        # bitcoinIIId behaves properly when a version is sent unexpectedly (but
        # tolerably) early.
        #
        # This checks that bitcoinIIId sends its own version prior to processing
