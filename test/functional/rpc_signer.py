...
Verify that a bitcoinIIId node can use an external signer command.
...
class RPCSignerTest(BitcoinIIITestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart bitcoinIIId with -signer=<cmd>',
