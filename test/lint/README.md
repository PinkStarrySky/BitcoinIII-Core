...
```sh
DOCKER_BUILDKIT=1 docker build -t bitcoinIII-linter --file "./ci/lint_imagefile" ./ && docker run --rm -v $(pwd):/bitcoinIII -it bitcoinIII-linter
```
...
maintained:
* for `src/secp256k1`: https://github.com/bitcoinIII-core/secp256k1.git (branch master)
* for `src/leveldb`: https://github.com/bitcoinIII-core/leveldb-subtree.git (branch bitcoinIII-fork)
* for `src/crypto/ctaes`: https://github.com/bitcoinIII-core/ctaes.git (branch master)
* for `src/crc32c`: https://github.com/bitcoinIII-core/crc32c-subtree.git (branch bitcoinIII-fork)
* for `src/minisketch`: https://github.com/bitcoinIII-core/minisketch.git (branch master)

To do so, add the upstream repository as remote:

```
git remote add --fetch secp256k1 https://github.com/bitcoinIII-core/secp256k1.git
```
