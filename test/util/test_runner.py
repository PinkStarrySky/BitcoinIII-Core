...
# Copyright 2016-2017 The BitcoinIII Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
"""Test framework for bitcoinIII utils.
...
def main():
    ...
    bctester(os.path.join(env_conf["SRCDIR"], "test", "util", "data"), "bitcoinIII-util-test.json", env_conf)
...
def bctest(testDir, testObj, buildenv):
    ...
    if testObj["exec"] == "./bitcoinIII-util":
        execprog = os.getenv("BITCOINIIIUTIL", default=execprog)
    elif testObj["exec"] == "./bitcoinIII-tx":
        execprog = os.getenv("BITCOINIIITX", default=execprog)
    ...
    if "error_txt" in testObj:
        ...
        # That stderr is empty if no errors are expected. However, bitcoinIII-tx
